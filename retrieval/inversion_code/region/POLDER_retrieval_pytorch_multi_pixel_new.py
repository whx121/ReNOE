...
def process_data_block(block_info: Dict) -> List[Dict]:
    ...
    prior_path, config, model_dict, features_scaler, polder_time = \
        block_info['prior_path'], block_info['config'], block_info['model_dict'], \
            block_info['features_scaler'], block_info['polder_time']
...
def main():
    ...
    config.smoothness_weight_global = 0.03

    # 路径配置
    file_path = r'/media/amers/Seagate Backup Plus Drive/2006/2006_05_08/'

    file_name_list = [
        'POLDER3_L1B-BG1-033108M_2006-05-08T09-26-44_V1-01.h5',
        'POLDER3_L1B-BG1-033109M_2006-05-08T11-05-36_V1-01.h5',
        'POLDER3_L1B-BG1-033107M_2006-05-08T07-47-50_V1-01.h5',
    ...
    for file_name in file_name_list:
        ...
        output_name = f"{polder_time}_multi_pixel_indian.csv"
