...
if __name__ == "__main__":
    ...
    csv_name_list = [#'2006-03-18T05-32-07_single.csv',
                    #  '2006-03-18T05-32-07_single_br.csv',
                     '2007-03-29T06-25-44_multi_pixel_yuenanV3.csv']
    ...
    for csv_name in csv_name_list:
        ...
        df = df[df['AOD']>-0.05]
        # 定义输出目录
        output_dir = '/media/amers/WHX/NNOE_POLDER/retrieval/region/论文case/ResNOE/20070329/'
        os.makedirs(output_dir, exist_ok=True)

        # --- 数据准备 ---
        # 定义要处理的变量列表和对应的输出文件名
        variables_to_process = {
            "AOD": f"{polder_time}_AOD3.tif",
            "SSA": f"{polder_time}_SSA3.tif",
            "fineAOD": f"{polder_time}_FineAOD3.tif",
            "coarseAOD": f"{polder_time}_CoarseAOD3.tif",
